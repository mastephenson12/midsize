      ...
      <main>
        ...
        <section id="podcast" className="border-t border-slate-900 bg-slate-900/35 px-6 py-20">
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[.8fr_1.2fr] lg:items-center">
            <div className="rounded-3xl border border-amber-400/20 bg-slate-950 p-10 text-center"><div className="text-6xl" aria-hidden="true">🎙️</div><p className="mt-5 text-xs font-bold uppercase tracking-[0.2em] text-amber-400">The Honest Roofer Podcast</p><p className="mt-3 text-sm leading-relaxed text-slate-400">Roofing transparency for homeowners and modern operators.</p></div>
